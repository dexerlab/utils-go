...
type TObjectTag struct {
	...
	ObjectID        int64     `gorm:"column:object_id;type:bigint;primaryKey" json:"object_id,string"`
	TagID           int64     `gorm:"column:tag_id;type:bigint;primaryKey" json:"tag_id,string"`
