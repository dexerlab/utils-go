...
const TableNameTKline1Y = "t_kline_1y"

// TKline1Y mapped from table <t_kline_1y>
...
// TableName TKline1Y's table name
func (*TKline1Y) TableName() string {
	return TableNameTKline1Y
}
