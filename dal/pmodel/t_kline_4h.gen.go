...
const TableNameTKline4H = "t_kline_4h"

// TKline4H mapped from table <t_kline_4h>
...
// TableName TKline4H's table name
func (*TKline4H) TableName() string {
	return TableNameTKline4H
}
