...
func TestSol(t *testing.T) {
	...
	t.Log(evmRpc.GetTokenInfo(context.TODO(), "0x1E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82", false))
	t.Log(evmRpc.GetTokenInfo(context.TODO(), "0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82", false))
	...
	t.Log(solRpc.GetTokenInfo(context.TODO(), "J5tzd1ww1V1qrgDUQHVCGqpmpbnEnjzGs9LAqJxwkNde", false))
	t.Log(solRpc.GetTokenInfo(context.TODO(), "zxTtD4MMnEAgHMvXmfgPCyMY61ivxX5zwu12hTSqLoA", false))
	t.Log(solRpc.GetTokenInfo(context.TODO(), "zZRRHGndBuUsbn4VM47RuagdYt57hBbskQ2Ba6K5775", false))
	t.Log(solRpc.GetTokenInfo(context.TODO(), "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", false))
	t.Log(solRpc.GetTokenInfo(context.TODO(), "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v", false))

	suiRpc := NewSuiRpc(&loader.ChainInfo{Name: "SuiMainnet", Client: sui.NewSuiClient("https://fullnode.mainnet.sui.io:443")})
	t.Log(suiRpc.GetTokenInfo(context.TODO(), "0xaf5c10e828852ed8f5cdcc824a80dbe11693be84284aee5dea47d6c2810b4a1::hopcat::HOPCAT", false))
}
